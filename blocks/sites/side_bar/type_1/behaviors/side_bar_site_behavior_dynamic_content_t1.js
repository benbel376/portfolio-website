/**
 * Side Bar Site Dynamic Content Behavior
 * Site-specific dynamic content loading integration
 */
class SideBarSiteDynamicContent {
    constructor() {
        this.isInitialized = false;
        this.loadingQueue = new Map();
        
        console.log('Side Bar Site Dynamic Content initialized');
    }
    ...
    async init() {
        ...
        console.log('Side Bar Site Dynamic Content system ready');
    }
...
// Using topBarSiteDynamicContent name for compatibility with global_navigator
window.topBarSiteDynamicContent = new SideBarSiteDynamicContent();

// Export for module systems
if (typeof module !== 'undefined' && module.exports) {
    module.exports = SideBarSiteDynamicContent;
} 